...
Password reset links are generated by the backend and dispatched through the notification system. Console logging is enabled by default; real email delivery is enabled by SMTP environment variables:

```bash
APP_NOTIFICATIONS_EMAIL_ENABLED=true
APP_NOTIFICATIONS_EMAIL_FROM=your-email@gmail.com
APP_MAIL_HOST=smtp.gmail.com
APP_MAIL_PORT=587
APP_MAIL_USERNAME=your-email@gmail.com
APP_MAIL_PASSWORD=your-16-character-app-password
APP_MAIL_SMTP_AUTH=true
APP_MAIL_STARTTLS_ENABLE=true
```
